...
Logger::Logger(HamLab::DataShareClass & pDataShareIn, const std::string & name_in) : HamLab::PluginBase(pDataShareIn, name_in) {}
...
HamLab::PluginBase * Logger::create(HamLab::DataShareClass & data_share_, const std::string & name) { return new Logger(data_share_, name); }
